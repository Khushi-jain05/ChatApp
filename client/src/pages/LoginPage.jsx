          ...
          <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex
           flex-col gap-6 rounded-lg shadow-lg'>
            ...
            {!isDataSubmitted && (
                ...
                type="email" placeholder='Email Addrress' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2
            ...
            )}
            {
                currState==='Sign up' && isDataSubmitted && (
                    ...
                    role={4} className='p-2 border border-gray-500 rounded-md focus:outline-none 
            ...
            <div className='flex flex-col gap-2'>
                ...
                <span onClick={()=>{setCurrState("Login"); setIsDataSubmitted(false)}} className='font-medium text-violet-500 cursor-pointer'>Login here</span></p>
                        ...
                        <span onClick={()=>{setCurrState("Login")}} className='font-medium text-violet-500 cursor-pointer'>Click here</span></p>
                    )}
            </div>
